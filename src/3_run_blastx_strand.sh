...
do
    ...
    date
    filename=${f%.*}
    blastx -outfmt 6 -db ../DB/uniprot_sprot -query ../Output/${filename}.assembled.exon.gene.intergenic.fa -out ${filename}.assembled.exon.gene.intergenic.blastx.1e-3.out -evalue 1e-3 -num_threads 32 -num_alignments 1 -strand plus
done
